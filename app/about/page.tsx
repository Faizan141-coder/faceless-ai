    ...
    <div className="flex flex-col items-center justify-center min-h-screen text-black p-8">
      <div className="max-w-4xl">
        ...
        <p className="mb-4 text-sm">
          ...
          <span className="font-bold text-[#6742d9] italic">
          ...
          <span className="font-bold text-[#6742d9]">3 hours per video to complete</span>.
        </p>
        <p className="mb-4 text-sm">
          Then we had the idea - what if we could make a tool that automates
          Faceless channels for us. It would{" "}
          <span className="font-bold text-[#6742d9]">
        ...
        <p className="mb-4 text-[#6742d9] font-bold text-sm">
        ...
        <div className="flex flex-col items-center justify-center mt-7">
          <Button className="bg-[#6742d9] uppercase font-semibold px-6 hover:bg-[#6b7dda]">
            TRY IT OUT
          </Button>
        </div>
      </div>
